...
#elif defined MACHINE_HC_SWTGW218AS_PCB_V2
/*
 * Horaco HC-SWTGW218AS, PCB silkscreen "HC-SWTGW218AS_PCB-V2.0.1_19649".
 * This is the same PCB as the SWTG018AS-A V2.0 (unmanaged Ampcom variant),
 * only re-branded by Horaco as a Web Managed switch. The configuration below
 * is identical to MACHINE_SWTG018AS_A_V_2_0. See doc/devices/HC-SWTGW218AS_PCB-V2.md
