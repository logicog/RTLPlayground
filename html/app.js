...
th_auto:"システム",th_auto_sel:"システム (Selenized)",sy_display:"表示",sy_theme:"テーマ",sy_display_note:"このブラウザーにのみ保存されます。",th_light:"ライト",th_dark:"ダーク",
...
th_auto:"跟随系统",th_auto_sel:"跟随系统 (Selenized)",sy_display:"显示",sy_theme:"主题",sy_display_note:"仅保存在此浏览器中。",th_light:"浅色",th_dark:"深色",
...
nav_vlan:"VLANs",nav_l2:"Table MAC",nav_mirror:"Mirroring",nav_lag:"LAG",nav_eee:"EEE",
nav_bw:"Bande passante",nav_system:"Système",nav_fw:"Firmware",
...
d_traffic_h:"packets/s, live",d_txpps:"TX pps",d_rxpps:"RX pps",d_txbad:"TX bad",d_rxbad:"RX bad",
i_host:"Nom d'hote",i_ip:"Adresse IP",i_mask:"Masque réseau",i_gw:"Passerelle",i_mac:"MAC",i_fw:"Firmware",
i_built:"Built",i_hw:"Matériel",i_flash:"Flash",i_syslog:"Syslog",
...
p_rxpower:"RX puissance",p_txfault:"TX erreur",p_txdis:"TX désactivé",p_rxlos:"RX LOS",p_adv:"Annonces",
...
stp_txhold:"TX hold",stp_bridge_apply:"Appliquer les paramètres du pont",
...
st_rxb:"RX bad",st_details:"Détails",st_counters:"Compteur MIB",st_nonzero:"non-zero seulement",
...
v_ing_none:"Sélectionner en mode entrant pour au moins un port",v_vid_first:"Entrez un identifiant VLAN d'abord",
...
lag_hash:"Hash:",lag_note:"Un LAG nécessite au moins un membre pour être sauvegardé dans la configuration de démarrage; Utiliser un groupe vide fait office de remise à zero.",
lag_clear_q:"Effacer LAG {n}?",lag_clear_d:"Tous les ports membres vont redevenir normaux.",
...
sy_igmp:"IGMP snooping",sy_sysip:"IP du serveur",sy_server:"Serveur",sy_port:"Port",
...
sy_dhcp_d:"Le commutateur va demander une addresse via DHCP. Vous devrez rechercher sa prochaine adresse IP pour vous reconnecter.",
...
sy_pw_q:"Change admin password?",sy_pw_d:"Takes effect immediately for new logins. Save to flash to persist.",
sy_reboot_q:"Redémarrer le commutateur ?",sy_reboot_d:"Il y a des paramètres NON SAUVEGARDES qui vont être perdus. Sauvegarder les au préalable en mémoire flash si vous souhaitez les conserver.",
...
cw_saved:"Configuration de démarrage sauvegardée et vérifiée",cw_collect:"Recolement des modification des paramètres courants...",
t_applied:"Appliqué: {c}",t_cmds:"{n} commande(s) appliquée(s)",t_rejected:"commandes rejetées: {c}",t_failed:"echecs: {c}",
fw_title:"Mise à jour du firmware",
fw_intro:"Chargés une image RTLPlayground (512 KiB .bin). L'image est envoée en mémoire flash et sa somme de contrôle est vérifiée; en cas de succès le commutateur va redémarrer, re-verifiez l'image et appliquez-là. LA configuration de démarrage est conservée.",
fw_upload:"Charger",fw_checking:"{f}: {n} bytes. Vérification...",fw_size_err:"la taille est {n} alors que nous attendons 524288 (512 KiB)",
fw_magic_err:"Entête de banque de donnée manquant / LJMP magic: ce n'est pas une image de firmware",fw_crc_err:"Somme de contrôle erronée: image corrompue",
fw_valid:"Image RTLPlayground valide (taille, magic et somme de contrôle OK)",fw_q:"Chargement du firmware?",
