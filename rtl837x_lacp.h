...
/*
 * Timer units: one step of the LACP timers, taken every four system ticks,
 * 50 per second. A long pass of the main loop is caught up on a few steps at
 * a time, so a period is a range and the worst case is what matters.
 *
