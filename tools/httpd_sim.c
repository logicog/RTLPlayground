...
void send_eee(int s)
{
	...
	for (int i = 1; i <= PORTS; i++) {
		...
		json_object_object_add(v, "portNum", json_object_new_int(i));
		json_object_object_add(v, "isSFP", json_object_new_int(i < 5 ? 0 : 1));
		json_object_object_add(v, "eee_2g5", json_object_new_string("-"));
		json_object_object_add(v, "eee_1g", json_object_new_string("OK"));
		json_object_object_add(v, "eee_100m", json_object_new_string("-"));
		json_object_object_add(v, "eee_lp2g5", json_object_new_string("OK"));
		json_object_object_add(v, "eee_lp1g", json_object_new_string("-"));
		json_object_object_add(v, "eee_lp100m", json_object_new_string("-"));
