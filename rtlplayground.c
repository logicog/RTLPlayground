 ...
 */
bool strstart(register __xdata const uint8_t *a, register __code const uint8_t *b)
{
	uint8_t i = 0;
...
bool strstart_x(register __xdata const uint8_t *a, register __xdata const uint8_t *b)
{
	uint8_t i = 0;
